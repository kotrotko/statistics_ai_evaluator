...
Evaluation method name: def grade_hw14_1_answer
"""
import re
import textwrap
...
class HW14_1Evaluator(BaseEvaluator):
    """
    Evaluator for Homework 14 Task 1.

    Task: What does a goodness-of-fit test assess?

    Rubric:
    Formatting (4 points: name, title, task description, no autoformatting)
    Definition (6 points)
    Key Components (5 points)
    ...
    def grade_hw14_1_answer(self, student_answer: str, test_mode: bool = False):
        if test_mode:
            return self.create_mock_result(
                ...
                vibe="Student understands goodness-of-fit tests correctly."
            )
...
Expected idea:
A goodness-of-fit test assesses how well observed data match a theoretical or expected distribution.

Full credit requires:
- mentions observed data/frequencies
- mentions theoretical/expected distribution
- states the test evaluates the match or fit
- links to chi-square or statistical testing context

Component 3: Key Components (5 points)
Expected:
- observed frequencies (O)
- expected frequencies (E)
- comparison between O and E
- mention of chi-square statistic or similar formula

Component 4: Interpretation (5 points)
Expected ideas:
- small differences between O and E attributed to chance
- large differences suggest data do not follow the specified model
- result indicates whether to reject or fail to reject the null hypothesis
- null hypothesis = data follow the specified distribution
  ...
  "vibe": "<one sentence overall impression>"
    ...
    def print_grading_results(self, grading):
        ...
        if "component_1_score" in grading:
            ...
            print(f"Key Components: {grading.get('component_3_score')}/5")
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("HOMEWORK 14.1 EVALUATOR")
    print("Chi-Square Goodness of Fit")
    print("=" * 60)
    print("\nPlease enter the student's answer to HOMEWORK 14_1.")
    ...
    grading = evaluator.grade_hw14_1_answer(student_answer)
