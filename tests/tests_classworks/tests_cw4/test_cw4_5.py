...
SAVE LOCATION: tests/tests_classworks/tests_cw4/test_cw4_5.py

RUN WITH: pytest tests/tests_classworks/tests_cw4/test_cw4_5.py -v

Regression tests for the deterministic Component 1 (Formatting) override
in classwork/classwork_4/cw4_5.py's grade_cw4_5_answer method.
...
# tests/tests_classworks/tests_cw4/test_cw4_5.py -> project root is 3 levels up
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "../../..")))

from classwork.classwork_4.cw4_5 import CW4_5Evaluator


@pytest.fixture
def evaluator():
    """Deterministic fixture providing a clean evaluator instance for every test."""
    return CW4_5Evaluator()
...
def _mock_llm_json(component_1_score, component_1_task_score, component_1_autoformat_score):
    ...
    to verify the deterministic override in grade_cw4_5_answer corrects it
...
def test_component1_forced_when_td_absent(evaluator):
    ...
    "please explain" is absent from the student answer. The deterministic
    ...
    with patch.object(evaluator, "call_groq_api", return_value=fake_response):
        result = evaluator.grade_cw4_5_answer(student_answer)
